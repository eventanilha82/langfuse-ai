...
export default function OracleLogo({ accentColor = "#C74634", isDarkBg = false, maxHeight = 100, style }: any) {
  ...
  const leftTransition: any = { type: "spring", stiffness: 45, damping: 13, mass: 1.2 };
  const rightTransition: any = { type: "spring", stiffness: 45, damping: 13, mass: 1.2, delay: 0.08 };
